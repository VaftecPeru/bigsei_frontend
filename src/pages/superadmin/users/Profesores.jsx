...
function Profesores() {
    ...
    const rows = originalRows.filter(
        (row) =>
        ...
        <div className="flex flex-col justify-start items-center min-h-screen text-lg w-full bg-sky-50 p-6">
            ...
            <Dialog open={openModalAdd} onClose={handleCloseModalAdd} maxWidth="xs" fullWidth className="backdrop-blur-md">
                <div className="text-2xl p-2 font-bold text-center mt-4">
                    <p>{isEditing ? "Editar Profesor" : "Registrar Profesor"}</p>
                </div>
                <DialogContent>
                    <TextField autoFocus margin="dense" label="DNI" fullWidth />
                    <TextField margin="dense" label="Apellidos" fullWidth />
                    <TextField margin="dense" label="Nombres" fullWidth />
                </DialogContent>
                <div className="flex justify-end p-4">
                    <Button onClick={handleCloseModalAdd} variant="outlined">
                        Cancelar
                    </Button>
                    <Button onClick={handleConfirmAddOrEdit} variant="contained" color="primary">
            ...
            <Dialog open={openModal} onClose={handleCloseModal} maxWidth="xs" fullWidth>
                <DialogTitle>¿Eliminar este profesor?</DialogTitle>
