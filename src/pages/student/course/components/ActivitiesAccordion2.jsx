...
import ModalVerGrabacion from "./ModalVerGrabacion";
...
function ActivitiesAccordion2({ setIsActiveModal, modulo }) {
  ...
  const handleTemas = () => {
    apiClient.get(Api_Global_Estudiante.miAcademicoPeriodoTemas.listar({
      per_page: 15,
      page: 1,
    ...
    <>
      ...
      {isActivityOpen && semanas.map((semana, index) => (
        <React.Fragment key={semana.id_periodotema}>
          <div className="w-[90%] bg-blue-300 h-[50px] transition duration-200 transition-all">
            <div className="w-full bg-blue-50 h-full" onClick={() => handleWeekClick(semana.id_periodotema)}>
              <div className="w-full flex items-center cursor-pointer relative transition duration-200 rounded rounded-md h-full hover:bg-blue-200 py-2 overflow-hidden">
            ...
            >
              <div className="w-full flex justify-between items-center">
                <div className="flex items-center justify-center">
                  ...
                  <div className="ml-4">
                    <span className="text-base text-blue-500 font-light">TAREA</span>
                    <br />
                    <span className="text-xs text-blue-700">Realizar estructura de control (PPT)</span>
                  </div>
                </div>
                <span
              ...
              <div className="w-full flex justify-between items-center">
                <div className="flex items-center justify-center">
                  ...
                  <div className="ml-4">
                    <span className="text-base text-blue-500 font-light">PRESENTACIÓN</span>
                    <br />
                    <span className="text-xs text-blue-700">Realizar estructura de control (PPT)</span>
                  </div>
                </div>
              ...
              <div className="w-full flex justify-between items-center">
                <div className="flex items-center justify-center">
                  ...
                  <div className="ml-4">
                    <span className="text-base text-blue-500 font-light">CUESTIONARIO</span>
                    <br />
                    <span className="text-xs text-blue-700">Realizar estructura de control (PPT)</span>
                  </div>
                </div>
              ...
              <div className="w-full flex justify-between items-center">
                <div className="flex items-center justify-center">
                  ...
                  <div className="ml-4">
                    <span className="text-base text-blue-500 font-light">GRABACIÓN</span>
                    <br />
                    <span className="text-xs text-blue-700">Última clase {semana.fecha}</span>
                  </div>
                </div>
                <span
                  className="h-[28px] w-[50px] flex justify-center items-center
      ...
      {isOpenSubirGrabacionModal && (
        <ModalVerGrabacion clickClose={() => setIsOpenSubirGrabacionModal(false)} tema={tema} />
      )}
    </>
  );
}
