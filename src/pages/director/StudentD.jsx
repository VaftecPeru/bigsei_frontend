...
function StudentD() {
    ...
    const handleEstudiantes = (text_search = "") => {
        setIsLoading(true);
        apiClient.get(Api_Global_Director.estudiantes.listar(text_search))
            .then((response) => {
                setIsLoading(false);
            ...
            <div className="w-full max-w-7xl p-2 bg-white">
                <div className="flex justify-between items-center mb-4 mt-5">
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={() => handleEstudiantes(searchTerm)}
