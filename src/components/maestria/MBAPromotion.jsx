      ...
      <div className="flex-1">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            Máster en Negocios<br />
            Administración (MBA)
          </h1>
          <p className="text-lg text-gray-600">
            Accede a tu próximo gran puesto adquiriendo una visión empresarial de primer nivel
            y una experiencia práctica y completa con
            University of Roehampton. Aprender de forma flexible, en casa o en el
            ir.
          </p>
        </div>
        ...
        <div className="mt-4 flex flex-col md:flex-row justify-between items-start md:items-center py-4  w-[90%] mx-auto">
          ...
          <div className="flex flex-col mb-3 md:mb-0">
            ...
            <span className="text-gray-800 font-medium">2 años tiempo promedio</span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-gray-800 font-medium">Ingles</span>
          </div>
        </div>
      </div>
      <div>
